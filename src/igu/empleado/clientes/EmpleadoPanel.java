...
import igu.empleado.clientes.EmpleadoTableModel;
...
public class EmpleadoPanel extends javax.swing.JPanel {
    ...
    EmpleadoTableModel eTableModel = new EmpleadoTableModel();
    ...
    private void paintTable(EmpleadoTableModel tableModel) {
        this.eTableModel = tableModel;
    ...
    private void paintForm() {
        if (table.getSelectedRow() != -1) {
            Empleado filax = (Empleado) eTableModel.getRow(table.getSelectedRow());
            Empleado d = EmpleadoData.getByPId(filax.getId());
    ...
    private void guardarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarButtonActionPerformed
        ...
        if (this.nombres.getText().equals("")) {
            ...
            if (table.getSelectedRow() != -1) {// ha seleccionado, update
                try {
                    Empleado fila = (Empleado) eTableModel.getRow(table.getSelectedRow());
                    s.setId(fila.getId());
                    System.out.println("id:" + s.getId());
                    if (s.getId() > 0) {
                        int returnId = EmpleadoData.update(s);
                        if (returnId != 0) {
                            paintTable(new EmpleadoTableModel());
                            resetForm();
                ...
                try {
                    int returnId = EmpleadoData.create(s);
                    if (returnId != 0) {
                        paintTable(new EmpleadoTableModel());
        ...
        if (table.getSelectedRow() != -1) {
            try {
                ...
                if (opc == JOptionPane.OK_OPTION) {
                    ...
                    int opcion = EmpleadoData.delete(fila.getId());
                    if (opcion != 0) {
                        //tableModel.removeRow(tamble.getSelectedRow());
                        paintTable(new EmpleadoTableModel());
                        resetForm();
                        guardarButton.setText("REGISTRAR");
                        guardarButton.setToolTipText("REGISTRAR");
    ...
    private void buscarFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buscarFieldKeyReleased
        // TODO add your handling code here:
        EmpleadoTableModel tableModel = new EmpleadoTableModel(buscarField.getText());
    ...
    private void theButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_theButton4ActionPerformed
        ...
        try {
            ...
            ErrorLogger.log(Level.SEVERE, EmpleadoPanel.class.getName() + ".ExportarExcel", ex);
            //Logger.getLogger(EmpleadosPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
